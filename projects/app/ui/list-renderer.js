...
export function renderTargetList(onEdit) {
  ...
  allItem.innerHTML = `
    <div class="drag-handle" style="opacity: 0; cursor: default; pointer-events: none;">
    ...
    <div class="target-info">
      <div class="target-color-chip" style="background-color: var(--md-sys-color-primary);"></div>
